...
<body>
    ...
    <section class="sectionIndex">
        <div class="container">
            <h2 class="baslik1">Seyahat Yazıları</h2>
            <div class="w-100 mb-4">
                ...
                <div class="row shadow">
                    <div class="col-md-4 mt-2">
                        ...
                        <p class="text-end devamOku"><a class="text-decoration-none text-black-50" href="seyahatYazilari/hadrian.php">Devamını Oku<i class="fa-solid fa-circle-arrow-right me-5 ms-2"></i></a></p>
                    </div>
                    <div class="col-md-4 mt-2">
                        ...
                        <p class="text-end devamOku"><a class="text-decoration-none text-black-50 " href="seyahatYazilari/kalekoy.php">Devamını Oku<i class="fa-solid fa-circle-arrow-right me-5 ms-2"></i></a></p>
                    </div>
                    <div class="col-md-4 mt-2">  
                        <img class="resim img-thumbnail" src="images/Pamukkale-Denizli.jpg"><p>
                        <p class="baslik2">Pamukkale, Denizli</p>
                        <p class="text-black-50"><i class="fa-solid fa-calendar-days me-2"></i>27.05.2022</p>
                        <p class="icerikyazi">
                            UNESCO Dünya Miras Listesi'nde yer alan Pamukkale, pamuk hissi veren beyaz travertenleriyle eşsiz bir görüntüye sahip.</p> 
                        </p>
                        <p class="text-end devamOku"><a class="text-decoration-none text-black-50" href="seyahatYazilari/pamukkale.php">Devamını Oku<i class="fa-solid fa-circle-arrow-right me-5 ms-2"></i></a></p>
                    </div>
                </div>
            </div>


            <h2 class="baslik1">Kategoriler</h2>
            <div class="w-100 mb-4">
                
                <div class="row shadow">
                    <div class="col-md-4 mt-2">
                        <a class="baslik2" href="tarihi.php"><img class="resim img-thumbnail" src="images/Hasankeyf-Mardin.jpeg">
                        <p>
                        Tarihi Mekanlar
                        </p>
                        </a>
                    ...
                    <div class="col-md-4 mt-2">
                        <a class="baslik2" href="dogal.php"><img class="resim img-thumbnail" src="images/MekeGolu-Konya.jpeg">
                        <p>
                        Doğal Güzellikler
                        </p>
                        </a>
                    ...
                    <div class="col-md-4 mt-2">  
                        <a class="baslik2" href="spor.php"><img class="resim img-thumbnail" src="images/Uzungol-Trabzon.jpeg">
                        <p>
                        Spor Turizmi
                        </p>
                        </a>
            ...
            <h2 class="baslik1">Öneriler</h2>
            <div class="w-100 pb-md-4">
                
                <div class="row shadow">
                    <div class="col-md-4 mt-2">
                        <a class="baslik2" href=""><img class="resim img-thumbnail" src="images/Hasankeyf-Mardin.jpeg">
                        <p>
                        Öneri 1
                        </p>
                        </a>
                    ...
                    <div class="col-md-4 mt-2">
                        <a class="baslik2" href=""><img class="resim img-thumbnail" src="images/MekeGolu-Konya.jpeg">
                        <p>
                        Öneri 2
                        </p>
                        </a>
                    ...
                    <div class="col-md-4 mt-2">  
                        <a class="baslik2" href=""><img class="resim img-thumbnail" src="images/Uzungol-Trabzon.jpeg">
                        <p>
                        Öneri 3
                        </p>
                        </a>
