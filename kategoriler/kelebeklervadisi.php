...
<body>
    ...
    <section class="sectionIndex">
        <div class="container">
            <h2 class="baslik3">Kelebekler Vadisi</h2>
            <div class="w-200 pb-3">
                
                <div class="row shadow">
                    <div class="img col-6 w-100">
                      <img class="resim2 img-thumbnail mx-auto ms-4" src="../images/kelebekler-vadisi.webp">
                        <img class="resim2 img-thumbnail mx-auto ms-4" src="../images/kelebekler-vadisi2.webp">
                   </div>
                        
                        <p class="icerikyazi2">
                            Muğla‘nın Fethiye ilçesinde iki yüksek yamaç arasından filizlenen Kelebekler Vadisi, el değmemiş güzelliğiyle ziyaretçilerini büyülüyor. <br><br>

                            1995’te 1. derece doğal sit alanı ilan edilen vadide 80’i aşkın kelebek çeşidi yaşıyor. Adını da bu kelebeklerden almış. <br><br>
                            
                            İçerisinde 50 metre yükseklikten dökülen bir de şelale var. Bu şelale vadinin içerisinden geçen bir dereye dökülüyor. <br><br>
                            
                            Kelebekler Vadisi son derece özel bir bölge. Temiz ve berrak sularının yanı sıra incecik kumlara sahip.<br><br>

Vadinin içerilerine doğru ilerlediğiniz kelebeklere rastlıyorsunuz. Ancak çok ses yapmamaya özen gösterin. Kelebekler gürültüden rahatsız olup davranış bozukluğu gösterebilir, hatta ölebilirler.<br><br>

Trekking ve tırmanış için oldukça uygun bir yapıya sahip olan Kelebekler Vadisi’nde mutlaka kamp kurmalısınız. Rahatına düşkün olanlar içinse bungalovlar bulunuyor.<br><br>
                        </p> 
        ...
        <div class="container col-4">
            <div class="row pb-3">
                <div class="btn-group dropup">
                    ...
                    <li><a class="dropdown-item" href="mekegolu.php">Meke Gölü</a></li>
                    <li><a class="dropdown-item" href="pamukkale.php">Pamukkale</a></li>
                    <li><a class="dropdown-item" href="saklıkent.php">Saklıkent Kanyonu</a></li>
                    <li><a class="dropdown-item disabled" href="kelebeklervadisi.php">Kelebekler Vadisi</a></li>
                    </ul>
                </div>
            </div>
        </div>    
