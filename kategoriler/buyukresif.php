...
<body>
    ...
    <section class="sectionIndex">
        <div class="container">
            <h2 class="baslik3">Büyük Resif</h2>
            <div class="w-200 pb-3">
                
                <div class="row shadow">
                    <div class="img col-6 w-100">
                        <img class="resim2 img-thumbnail mx-auto ms-4" src="../images/buyukresif.jpg">
                        <img class="resim2 img-thumbnail mx-auto ms-4" src="../images/buyukresif2.jpg">
                   </div>
                        
                        <p class="icerikyazi2">
                            Bu dalış bölgesi Kızıldeniz göçmenlerine ev sahipliği yapan ve aynı zamanda Ege bölgesindeki bütün sualtı canlılarını bir arada görebileceğiniz bir dalış noktasıdır. Dalışa yeni başlamış dalgıçlar içinde oldukça uygundur.  Dalışlar 4 metreden başlayarak 32-36 metrelere kadar gitmektedir. Bodrum 12 ay dalış severlere açıktır olsa da kışın su sıcaklığı 14-15 derecelere düşebilir.<br><br>

                            Türkiye’nin en iyi dalış noktalarından biri olan Bodrum’da, ayrıca resif dalışı, Delikli Mağara dalışı , batık  dalışı yapabileceğiniz mevkiler mevcut.
                        </p> 
        ...
        <div class="container col-4">
            <div class="row pb-3">
                <div class="btn-group dropup">
                    ...
                    <li><a class="dropdown-item disabled" href="buyukresif.php">Büyük Resif</a></li>
