...
<body>
    ...
    <section class="sectionIndex">
        <div class="container">
            <h2 class="baslik3">Saklıkent Kanyonu</h2>
            <div class="w-200 pb-3">
                
                <div class="row shadow">
                    <div class="img col-6 w-100">
                        <img class="resim2 img-thumbnail mx-auto ms-4" src="../images/saklıkent2.jpg">
                        <img class="resim2 img-thumbnail mx-auto ms-4" src="../images/saklıkent.webp">
                   </div>
                        
                        <p class="icerikyazi2">
                            Türkiye’nin cennet köşesi Fethiye, birçok doğal güzelliğe ev sahipliği yapıyor. Ölüdeniz, hem yerli hem de yabancı turistlerin ilgi odağındayken Saklıkkent Kanyonu biraz daha göz ardı edilmiş gözüküyor. <br> <br>

                            26 sene önce bir çoban tarafından keşfedilen Saklıkent’te Mayıs ayında dağlarda eriyen kar suları kayalardan akarak cennete doğru yol alır.<br> <br>
                            
                            Kanyonun doğa mucizelerini barındırması Saklıkent Milli Parkı’nın kurulmasına ön ayak olmuş. Parktan adımınızı attığınızda kanyonun girişiyle karşılaşacaksınız.<br> <br>
                            
                            Suyun içindeki kayalardan yürümek zorunda olduğunuz için sandalet veya lastik ayakkabı giymenizde yarar var.
                            
                            İlk başlarda sakin sular kanyonda ilerledikçe hırçınlaşıyor. İki yanınız da ağaçlar ve kayalarla çevriliyken içinde bulunduğunuz su giderek soğumaya başlayacak.<br> <br>
        ...
        <div class="container col-4">
            <div class="row pb-3">
                <div class="btn-group dropup">
                    ...
                    <li><a class="dropdown-item disabled" href="saklıkent.php">Saklıkent Kanyonu</a></li>
                    <li><a class="dropdown-item" href="kelebeklervadisi.php">Kelebekler Vadisi</a></li>
                    </ul>
                </div>
            </div>
        </div>    
