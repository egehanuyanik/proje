...
<body>
    ...
    <section class="sectionIndex">
        <div class="container">
            <h2 class="baslik3">Ali Dağı</h2>
            <div class="w-200 pb-3">
                
                <div class="row shadow">
                    <div class="img col-6 w-100">
                        <img class="resim2 img-thumbnail mx-auto ms-4" src="../images/ali-dagi-kayseri.jpg">
                        <img class="resim2 img-thumbnail mx-auto ms-4" src="../images/Ali Dağı2.jpg">
                   </div>
                        
                        <p class="icerikyazi2">
                            Yolu Kayseri’ye düşen ekstrem spor meraklıları, iki macerayı aynı anda yaşayabilir. Yamaç paraşütü yapmak isteyenler için tandem uçuş olanağı sağlayan Ali Dağı tesisleri, aynı zamanda Ali Dağı Yeraltı Şehri’ne de çok yakın. Böylece Kayseri’ye giden macera tutkunları, göklerde süzülmenin keyfini çıkardıktan sonra yeraltı şehrinin gizemlerini çözebileceği bir serüvene de atılabiliyor.<br><br>

                            Kayseri Ali Dağı yamaç paraşütü tesislerinde tandem uçuşlarına katılacak kişileri yaklaşık 10 dakikalık bir eğitim bekliyor. Buradaki yamaç paraşütü deneyimi, hava durumuna bağlı olarak 10 – 30 dakika arasında sürede tamamlanıyor. Yükseklik yaklaşık 1750 metre ve çoğunlukla kuzey rüzgarları görülüyor.
                        </p> 
        ...
        <div class="container col-4">
            <div class="row pb-3">
                <div class="btn-group dropup">
                    ...
                    <li><a class="dropdown-item disabled" href="alidagi.php">Ali Dağı</a></li>
                    <li><a class="dropdown-item" href="bozdag.php">Bozdağ</a></li>
                    <li><a class="dropdown-item" href="buyukresif.php">Büyük Resif</a></li>
                    <li><a class="dropdown-item" href="uludag.php">Uludağ</a></li>
                    </ul>
                </div>
            </div>
        </div>  
