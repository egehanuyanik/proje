...
<body>
    ...
    <section class="sectionIndex">
        <div class="container">
            <h2 class="baslik3">Nemrut Dağı</h2>
            <div class="w-200 pb-3">
                
                <div class="row shadow">
                    <div class="img col-6 w-100">
                        <img class="resim2 img-thumbnail mx-auto ms-4" src="../images/nemrut-dağı.webp">
                        <img class="resim2 img-thumbnail mx-auto ms-4" src="../images/nemrut-dağı-2.webp">
                   </div>
                        
                        <p class="icerikyazi2">
                            Batı kıyılarına biraz uzak olsa da dünyanın dört bir yanından turistin Nemrut Dağı’na gelmelerinin bir sebebi var. <br><br>

                            Adıyaman‘ın Kahta ilçesinde konumlanan Nemrut Dağı 2150 metre yüksekliğinde. Dağın yamaçlarında, zamanın Kommagene Kralı I. Antiochos tarafından, tanrılara ve atalarına minnettarlığını sunmak için inşa ettirdiği mezarı ve anıtsal heykeller bulunuyor. Bu kalıntılara Nemrut Dağı’nın büyüleyici manzarası eklenince ortaya bir şaheser çıkıyor.<br><br>
                            
                            Bu kalıntılar, Helenistik Dönem’in en görkemli kalıntıları arasında gösteriliyor. Heykeller, doğa, batı ve kuzey teraslarında konumlanıyor. Doğu terası kutsal merkez sayıldığı için en önemli heykeller burada yer alıyor.<br><br>

Günümüze kadar ulaşmayı başarmış anıtsal heykeller kireç taşı bloklarından inşa edilmiş olup boyları 8 – 10 metreye kadar ulaşabiliyor. Nemrut Dağı’ndaki tek eksik ise varlığı bilinse de halen keşfedilememiş olan I. Antiochos’un mezarı.<br><br>
        ...
        <div class="container col-4">
            <div class="row pb-3">
                <div class="btn-group dropup">
                    ...
                    <li><a class="dropdown-item disabled" href="nemrut.php">Nemrut Dağı</a></li>
                    </ul>
                </div>
            </div>
        </div>    
