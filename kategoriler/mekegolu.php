...
<body>
    ...
    <section class="sectionIndex">
        <div class="container">
            <h2 class="baslik3">Meke Gölü</h2>
            <div class="w-200 pb-3">
                
                <div class="row shadow">
                    <div class="img col-6 w-100">
                        <img class="resim2 img-thumbnail mx-auto ms-4" src="../images/MekeGolu-Konya.jpeg">
                        <img class="resim2 img-thumbnail mx-auto ms-4" src="../images/mekegolu2.jpg">
                   </div>
                        
                        <p class="icerikyazi2">
                            Konya’nın Karapınar ilçe sınırları içerinde yer alan Meke Gölü, ülkemizin sahip olduğu doğal güzelliklerden biridir. Her yıl çok sayıda yerli ve yabancı turistin ilgisini çeken bu göl, bir krater gölüdür ve sönmüş bir volkan kraterinin su dolması ile oluşmuştur. <br> <br>
                            Deniz seviyesinden yüksekliği 918 metre olan gölün suyu oldukça tuzludur ve derinliği 12 metreyi bulmaktadır. Doğal güzellikleri ile bilinen Karapınar’ın özel duraklarından biri olan Meke Gölü’nün yanı sıra yanı sıra Obruk Gölü, Obruk Yaylası ve Karapınar Çölü de bölgede mutlaka ziyaret edilmesi gereken yerlerin başında gelmektedir. <br> <br>
        ...
        <div class="container col-4">
            <div class="row pb-3">
                <div class="btn-group dropup">
                    ...
                    <li><a class="dropdown-item disabled" href="mekegolu.php">Meke Gölü</a></li>
