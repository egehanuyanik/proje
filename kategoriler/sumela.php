...
<body>
    ...
    <section class="sectionIndex">
        <div class="container">
            <h2 class="baslik3">Sümela Manastırı
            </h2>
            <div class="w-200 pb-3">
                
                <div class="row shadow">
                    <div class="img col-6 w-100">
                        <img class="resim2 img-thumbnail mx-auto ms-4" src="../images/sumela.jpg">
                        <img class="resim2 img-thumbnail mx-auto ms-4" src="../images/sumela2.webp">
                   </div>
                        
                        <p class="icerikyazi2">
                            Rum Ortodoks manastırı ve kilise kompleksinden oluşan Sümela Manastırı, Trabzon’un Maçka ilçesinde, sarp bir tepede yer alıyor.<br><br>
                            Kapadokya’da da örnekleri görülen Hristiyanlığın ilk dönemindeki kilise mimarisi anlayışla inşa edilen Sümela, deniz seviyesinden bin 150 metre yükseklikte<br><br>
                            Duvarlarındaki freskler ve figürleriyle ziyaretçilerini büyüleyen manastırda yılda bir kez ayin yapılıyor.
                        </p> 
        ...
        <div class="container col-4">
            <div class="row pb-3">
                <div class="btn-group dropup">
                    ...
                    <li><a class="dropdown-item disabled" href="sumela.php">Sümela Manastırı</a></li>
