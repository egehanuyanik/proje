...
<body>
    ...
    <section class="sectionIndex">
        <div class="container">
            <h2 class="baslik3">Uludağ</h2>
            <div class="w-200 pb-3">
                
                <div class="row shadow">
                    <div class="img col-6 w-100">
                        <img class="resim2 img-thumbnail mx-auto ms-4" src="../images/uludag.webp">
                        <img class="resim2 img-thumbnail mx-auto ms-4" src="../images/uludag2.jpg">
                   </div>
                        
                        <p class="icerikyazi2">
                            Bursa şehir merkezine yalnızca 40 km uzaklıkta konumlanan Uludağ’a hem İstanbul hem de Yalova tarafından ulaşım oldukça kolay.<br><br>
                            Uludağ yaylaları ile olduğu kadar devasa kayak merkeziyle de ön plana çıktığı için buraya gelebileceğiniz en uygun dönem aralık ve ocak ayları.

Uludağ’ın en yoğun sezonu olarak kabul edilen aralık ve ocak ayları dışında da ziyaret edebileceğiniz Uludağ’ı yaylalarını da gezebilirsiniz.<br><br>

Yüksekliği 2543 metre olan Uludağ, Türkiye’nin en büyük kış ve doğa sporları merkezi olma unvanına sahip. <br><br>
1. Bölge’nin kalbi niteliğindeki, en hareketli yerlerden biri olan Beceren pisti de 900 metre uzunluğa sahip. <br><br>
Zirve, Kuşaklıkaya (Şahinkaya), Tutyeli, Cennet Kaya ve Fatin olmak üzere 5 tepeden meydana gelen Uludağ Kayak Merkezi’nin en uzun pisti 2750 metre uzunluğundaki Tutyeli pisti.
                        </p> 
        ...
        <div class="container col-4">
            <div class="row pb-3">
                <div class="btn-group dropup">
                    ...
                    Diğer Spor Turizmleri
                    </button>
                    <ul class="dropdown-menu w-75 ms-5 mb-2 text-center bg-success">
                    <li><a class="dropdown-item" href="alidagi.php">Ali Dağı</a></li>
                    <li><a class="dropdown-item" href="bozdag.php">Bozdağ</a></li>
                    <li><a class="dropdown-item" href="buyukresif.php">Büyük Resif</a></li>
                    <li><a class="dropdown-item disabled" href="uludag.php">Uludağ</a></li>
                    </ul>
                </div>
            </div>
        </div>      
